...
<div class="database-info-container">
  <SqlKnowledgeFileDetailModal/>

  <!-- 检索配置弹窗 -->
  <SqlKnowledgeSearchConfigModal
    v-model="searchConfigModalVisible"
    :database-id="databaseId"
    @save="handleSearchConfigSave"
  />

  <SqlKnowledgeFileUploadModal
  ...
  <div class="unified-layout">
    <div class="left-panel" :style="{ width: leftPanelWidth + '%' }">
      <SqlKnowledgeBaseCard/>
      <SqlKnowledgeFileTable
...
import SqlKnowledgeBaseCard from '@/components/SqlKnowledgeBaseCard.vue';
// import FileTable from '@/components/FileTable.vue';
import SqlKnowledgeFileTable from '@/components/SqlKnowledgeFileTable.vue';
import SqlKnowledgeFileDetailModal from '@/components/SqlKnowledgeFileDetailModal.vue';
import SqlKnowledgeFileUploadModal from '@/components/SqlKnowledgeFileUploadModal.vue';
import KnowledgeGraphSection from '@/components/KnowledgeGraphSection.vue';
import SqlKnowledgeQuerySection from '@/components/SqlKnowledgeQuerySection.vue';
...
import SqlKnowledgeSearchConfigModal from '@/components/SqlKnowledgeSearchConfigModal.vue';
import DatabaseUploadModal from '@/components/DatabaseUploadModal.vue';


const route = useRoute();
const store = useSqlKnowledgeStore();
