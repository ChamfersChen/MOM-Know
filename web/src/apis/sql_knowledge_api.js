...
export const knowledgeApi = {
   ...
   */
  getDatabases: async () => {
    return apiAdminGet('/api/sql_knowledge/databases')
  },
  ...
  createDatabase: async (databaseData) => {
    return apiAdminPost('/api/sql_knowledge/databases', databaseData)
  },
  ...
  getDatabaseInfo: async (dbId) => {
    return apiAdminGet(`/api/sql_knowledge/databases/${dbId}`)
  },

  getDatabaseConnectionTables: async (databaseConfig) => {
    return apiAdminPost(`/api/sql_knowledge/databases/check`, databaseConfig)
  },

  importKnowledgeBaseFromDB: async (dbId, databaseConfig) => { 
    return apiAdminPost(`/api/sql_knowledge/databases/${dbId}/upload/database`, databaseConfig)
  },
  ...
  updateDatabase: async (dbId, updateData) => {
    return apiAdminPut(`/api/sql_knowledge/databases/${dbId}`, updateData)
  },
  ...
  deleteDatabase: async (dbId) => {
    return apiAdminDelete(`/api/sql_knowledge/databases/${dbId}`)
  },
  ...
  generateDescription: async (name, currentDescription = '', fileList = []) => {
    return apiAdminPost('/api/sql_knowledge/generate-description', {
      name,
...
export const documentApi = {
  ...
  createFolder: async (dbId, folderName, parentId = null) => {
    return apiAdminPost(`/api/sql_knowledge/databases/${dbId}/folders`, {
  ...
  moveDocument: async (dbId, docId, newParentId) => {
    return apiAdminPut(`/api/sql_knowledge/databases/${dbId}/documents/${docId}/move`, {
  ...
  addDocuments: async (dbId, items, params = {}) => {
    return apiAdminPost(`/api/sql_knowledge/databases/${dbId}/documents`, {
      items,
      params
    })
  },
  ...
  getDocumentInfo: async (dbId, docId) => {
    return apiAdminGet(`/api/sql_knowledge/databases/${dbId}/documents/${docId}`)
  },
  ...
  deleteDocument: async (dbId, docId) => {
    return apiAdminDelete(`/api/sql_knowledge/databases/${dbId}/documents/${docId}`)
  },
  ...
  downloadDocument: async (dbId, docId) => {
    return apiAdminGet(`/api/sql_knowledge/databases/${dbId}/documents/${docId}/download`, {}, 'blob')
  },
  ...
  parseDocuments: async (dbId, fileIds) => {
    return apiAdminPost(`/api/sql_knowledge/databases/${dbId}/documents/parse`, fileIds)
  },
  ...
  indexDocuments: async (dbId, fileIds, params = {}) => {
    return apiAdminPost(`/api/sql_knowledge/databases/${dbId}/documents/index`, {
      file_ids: fileIds,
      params
    })
  },
...
export const queryApi = {
  ...
  queryKnowledgeBase: async (dbId, query, meta = {}) => {
    return apiAdminPost(`/api/sql_knowledge/databases/${dbId}/query`, {
      query,
      meta
    })
  },
  ...
  queryTest: async (dbId, query, meta = {}) => {
    return apiAdminPost(`/api/sql_knowledge/databases/${dbId}/query-test`, {
      query,
      meta
    })
  },
  ...
  getKnowledgeBaseQueryParams: async (dbId) => {
    return apiAdminGet(`/api/sql_knowledge/databases/${dbId}/query-params`)
  },
  ...
  updateKnowledgeBaseQueryParams: async (dbId, params) => {
    return apiAdminPut(`/api/sql_knowledge/databases/${dbId}/query-params`, params)
  },
  ...
  generateSampleQuestions: async (dbId, count = 10) => {
    return apiAdminPost(`/api/sql_knowledge/databases/${dbId}/sample-questions`, {
      count
    })
  },
  ...
  getSampleQuestions: async (dbId) => {
    return apiAdminGet(`/api/sql_knowledge/databases/${dbId}/sample-questions`)
  }
}
...
export const fileApi = {
  ...
  uploadFile: async (file, dbId = null) => {
    ...
    const url = dbId
      ? `/api/sql_knowledge/files/upload?db_id=${dbId}`
      : '/api/sql_knowledge/files/upload'
  ...
  getSupportedFileTypes: async () => {
    return apiAdminGet('/api/sql_knowledge/files/supported-types')
  },
  ...
  uploadFolder: async (file, dbId) => {
    ...
    return apiRequest(`/api/sql_knowledge/files/upload-folder?db_id=${dbId}`, {
      method: 'POST',
      body: formData,
  ...
  processFolder: async ({ file_path, db_id, content_hash }) => {
    return apiAdminPost('/api/sql_knowledge/files/process-folder', {
      file_path,
      db_id,
      content_hash
    })
...
export const typeApi = {
  ...
  getKnowledgeBaseTypes: async () => {
    return apiAdminGet('/api/sql_knowledge/types')
  },
   ...
   */
  getStatistics: async () => {
    return apiAdminGet('/api/sql_knowledge/stats')
  }
}
...
export const embeddingApi = {
  ...
  getModelStatus: async (modelId) => {
    return apiAdminGet(`/api/sql_knowledge/embedding-models/${modelId}/status`)
  },
  ...
  getAllModelsStatus: async () => {
    return apiAdminGet('/api/sql_knowledge/embedding-models/status')
  }
}
...
export const evaluationApi = {
  ...
  uploadBenchmark: async (dbId, file, metadata = {}) => {
    ...
    return apiAdminPost(`/api/sql_knowledge/databases/${dbId}/benchmarks/upload`, formData)
  },
  ...
  getBenchmarks: async (dbId) => {
    return apiAdminGet(`/api/sql_knowledge/databases/${dbId}/benchmarks`)
  },
  ...
  getBenchmark: async (benchmarkId) => {
    return apiAdminGet(`/api/sql_knowledge/benchmarks/${benchmarkId}`)
  },
  /**
   * 获取评估基准详情（带db_id）
   * @param {string} dbId - 知识库ID
  ...
  getBenchmarkByDb: async (dbId, benchmarkId, page = 1, pageSize = 50) => {
    ...
    return apiAdminGet(`/api/sql_knowledge/databases/${dbId}/benchmarks/${benchmarkId}?${params}`)
  },
  ...
  deleteBenchmark: async (benchmarkId) => {
    return apiAdminDelete(`/api/sql_knowledge/benchmarks/${benchmarkId}`)
  },
  ...
  generateBenchmark: async (dbId, params) => {
    return apiAdminPost(`/api/evaluation/sql_knowledge/${dbId}/benchmarks/generate`, params)
  },
  ...
  runEvaluation: async (dbId, params) => {
    return apiAdminPost(`/api/evaluation/sql_knowledge/${dbId}/run`, params)
  },
  ...
  getEvaluationResultsByDb: async (dbId, taskId, params = {}) => {
    ...
    const url = `/api/evaluation/sql_knowledge/${dbId}/results/${taskId}${queryParams.toString() ? '?' + queryParams.toString() : ''}`;
    return apiAdminGet(url);
  },
  deleteEvaluationResultByDb: async (dbId, taskId) => {
    return apiAdminDelete(`/api/evaluation/sql_knowledge/${dbId}/results/${taskId}`)
  },
  ...
  getEvaluationHistory: async (dbId) => {
    return apiAdminGet(`/api/evaluation/sql_knowledge/${dbId}/history`)
  }
}
